        ...
        <section class="main">
            ...
            <div class="form-group row id">
                ...
                <div class="form-inline">  
                    ...
                    <button class="btn  my-2 my-sm-0" style="background-color:orangered;width:120px;margin-left:170px;" type="submit" id="insert" name="save">Save</button>
                    <?php else:?>
                    <button class="btn  my-2 my-sm-0" style="background-color:orangered; margin-left:170px;"  type="submit" id="insert" name="update">Update</button>
                    <?php endif;?>
                </div>
                <div id="content"></div>
            </form>
            ...
            <form action="std_search.php" method="post">
                ...
                <button type="submit" name="save" id="std_search" style="background-color:orangered;width:100px;margin-left:80px;" class="btn">Search</button>
          </form>
        ...
        <table class="table">
            ...
            <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="status1_re.php?edit=<?php echo $row['std_id']; ?>" class="btn btn-outline-success" style="width:50px">Edit</a></td>
                        <td><a href="status_process.php?delete=<?php echo $row['std_id']; ?>" class="btn btn-outline-danger text-center" id="insert" style="width:70px">Delete</a></td>
                    <?php endwhile;?>
            </tbody>
          </table>
    </section>
