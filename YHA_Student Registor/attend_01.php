...
<body>
    ...
    <?php endif ?>
      ...
      <section class="attendance" id="attend">
        <div class="attendance-list">
          ...
          <input style="width:100px;" type="button" class="btn btn-secondary" value="<?php 
            include("inc/dbcon.php");
          ...
          <span>Total Leave:</span>
            ...
            <button name="save" id="attend_search" class="btn btn-secondary" onclick="Function()">Search</button>
  ...
  <!--Script-->
        ...
        $(document).ready(function(){
           $('#attend_search').keyup(function(){
                var input = $(this).val();
                if(input != ''){
                    $.ajax({
                        url:"attend_search.php",
                        method:"post",
                        data:{input:input},
