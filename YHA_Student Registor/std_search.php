    ...
    <section class="main">
      ...
      <div>
        ...
        if(isset($_POST['save'])){
            ...
            $e_date = $_POST['e_date'];
            $sql = "SELECT s.*,stu.student_name,stu.phNo,sta.description FROM status_details AS s LEFT JOIN student AS stu ON s.student_id = stu.student_id LEFT JOIN status AS sta ON s.status_id = sta.id WHERE date BETWEEN '$st_date' AND '$e_date'";
