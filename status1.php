        ...
        <section class="main">
            ...
            <div class="form-group row id">
                ...
                <div class="form-inline">  
                    ...
                    <button class="btn  my-2 my-sm-0" style="background-color:#ff6b01;width:120px;margin-left:170px;" type="submit" name="save">Save</button>
                    <?php else:?>
            ...
            <form action="std_search.php" method="post">
                ...
                <button type="submit" name="save" id="std_search" style="background-color:#ff6b01;width:100px;margin-left:80px;" class="btn">Search</button>
          </form>
        ...
        <table class="table">
            ...
            <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="status1.php?edit=<?php echo $row['std_id']; ?>" class="btn btn-outline-success" style="width:70px">Edit</a></td>
