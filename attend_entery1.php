      ...
      <section class="attendance" id="attend">
        <div class="attendance-list">
            ...
            <form action="" method="post">
              ...
              <div class="con">
                  <form action="" method="" id="sec_form">
                    <input id="i1" type="text" value="text">
                    <input id="i2" type="text" value="text">
                    <input id="i3" type="text" value="text">
                    <input id="i4" type="text" value="text">
                    <input id="i5" type="text" value="text">
                    <input id="i6" type="text" value="text">
                    <input id="i7" type="text" value="text">
                    <input id="i8" type="text" value="text">
                    <input id="i9" type="text" value="text">
                    <input id="i10" type="text" value="text">
                    <input id="i11" type="button" value="Update">
                    <input id="i12" type="button" value="Delete">
                  </form>
              </div>
            </div>
            <!--End Select Option-->
