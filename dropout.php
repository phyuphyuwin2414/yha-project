        ...
        <div class="attendance-list">
          ...
          <table class="table">
            ...
            <?php
                    ...
                    $sql = "SELECT sd.*,s.*,r.*,sec.*,c.* FROM status_details AS sd LEFT JOIN status AS s ON sd.status_id=s.id LEFT JOIN register AS r ON sd.student_id=r.stu_id LEFT JOIN course AS c ON r.courseid=c.courseid LEFT JOIN section as sec ON r.sectionid=sec.sectionid WHERE status_id=2 ORDER BY dt_start DESC";
                ...
                ?>
                    <tr>
                        ...
                        <td class="btn" width="120px" style="margin-top:10px;padding:7px;background-color:#FFFF00;"><?php echo $row['description']; ?></td>
