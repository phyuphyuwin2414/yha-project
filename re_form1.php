            ...
            <div class="photo" style="margin-left:620px;">
                <div class="hero">
                    <div class="card">
                        ...
                        <!---->
                        <input type="file" name="stuimg" accept="img/jpeg, img/png, img/jpg" id="input-file">
                ...
                <?php
                    ...
                    ?>
                        <tr>
                            ...
                            <td><a href="re_form.php?edit=<?php echo $row['stu_id']; ?>" style="width:50px" class="btn btn-outline-info">Edit</a></td>
